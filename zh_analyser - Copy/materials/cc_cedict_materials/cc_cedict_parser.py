""" A parser for CC-Cedict. Convert the Chinese-English dictionary into a 
...
import sys
import os
cedict = os.path.join(os.path.dirname(__file__), 'cedict_modified.txt')
